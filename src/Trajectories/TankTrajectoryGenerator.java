...
public class TankTrajectoryGenerator {
	double maxAccel;
	double userCapVel;
	
	double rotationalToLinearDropoff;
	
	QuinticSpline path;
	ArrayList<TrajectoryPoint> pathpoints = new ArrayList<>();
	
	
	TankTrajectoryGenerator(double maxAcceleration, double userSetVelocity) {
		this.maxAccel = maxAcceleration;
		this.userCapVel = userSetVelocity;
	}
	public TankTrajectoryGenerator(double maxAcceleration, double userSetVelocity, ArrayList<Waypoint> constraints) {
		this.maxAccel = maxAcceleration;
		this.userCapVel = userSetVelocity;
